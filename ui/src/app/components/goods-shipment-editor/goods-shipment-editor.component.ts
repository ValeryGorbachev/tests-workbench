...
import { GoodsShipment, GoodsShipmentItem } from 'src/interfaces/goods-shipment';
import { SelectListItemDto } from 'src/interfaces/select-list-item-dto';
import { GoodsShipmentService } from '@/pages/service/goods-shipment.service';
...
@Component({
    selector: 'app-goods-shipment-editor',
    templateUrl: './goods-shipment-editor.component.html',
    styleUrls: ['./goods-shipment-editor.component.css'],
    standalone: true,
    imports: [
        CommonModule,
        ReactiveFormsModule,
...
export class GoodsShipmentEditorComponent implements OnInit {
    ...
    constructor(
        ...
        private service: GoodsShipmentService,
    ...
    addRow(item?: Partial<GoodsShipmentItem>) {
    ...
    save() {
        ...
        const data: GoodsShipment = {
            ...
            conducted: false,
            items: value.items.map((item: GoodsShipmentItem) => ({
