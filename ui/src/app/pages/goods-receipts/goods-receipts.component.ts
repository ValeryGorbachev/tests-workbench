...
import { GoodsReceiptEditorComponent } from '@/components/goods-receipt-editor/goods-receipt-editor.component';
...
export class GoodsReceiptsComponent {
    ...
    constructor(private service: GoodsReceiptService, private dialogService: DialogService) {}
    ...
    edit(documentId?: number) {
        this.dialogService.open(GoodsReceiptEditorComponent, {
            width: '60vw',
            height: '70vh',
            modal: true,
            closable: true,
